...
//--------------------------------------------------------------------------------------
technique11 RenderParticlesToBuffer
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_5_0, RenderParticlesVS( ) ) );
        SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_5_0, RenderParticlesDeferredPS( ) ) );
...
// Renders scene to render target using D3D10 Techniques
//--------------------------------------------------------------------------------------
technique11 CompositeParticlesToScene
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_5_0, CompositeParticlesVS( ) ) );
        SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_5_0, CompositeParticlesPS( ) ) );
...
technique11 RenderMeshInst
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_5_0, MeshInstVS( ) ) );
        SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_5_0, MeshPS( ) ) );
