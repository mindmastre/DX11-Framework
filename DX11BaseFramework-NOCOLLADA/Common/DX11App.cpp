...
MainWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	return gDX11App->MsgProc(hwnd, msg, wParam, lParam);
}

DX11App::DX11App(HINSTANCE hInstance)
:	mhAppInst(hInstance),
	mMainWndCaption(L"Zombie Force"),
...
DX11App::~DX11App()
{
	...
	//ReleaseCOM(gd3d9Device);
}

HINSTANCE DX11App::AppInst()const
{
	return mhAppInst;
}
...
float DX11App::AspectRatio()const
{
...
bool DX11App::InitDirect3D()
{
	...
	////Create DirectX9 device for use of depreciated methods
	...
	//md3dPP.BackBufferFormat           = mode.Format;
	...
	//HRESULT result;
	//result = (md3dObject->CreateDevice(
	//	D3DADAPTER_DEFAULT, 
	//	mDevType,           
	//	mhMainWnd,          
	//	devBehaviorFlags,   
...
void DX11App::CalculateFrameStats()
{
