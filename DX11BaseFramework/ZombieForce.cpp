...
bool ZombieForce::Init()
{
	...
	mSky = new Skybox(md3dDevice, L"../Assets/Textures/desertcube1024.dds", 5000.0f);
	...
	CMODELLOADER->ReadDaeFile("../Assets/Models/crossgravestone.dae", md3dDevice);
	...
	mesh->SetPosition(Vector3(50,0,0));
	CMODELLOADER->ReadDaeFile("../Assets/Models/zombie.dae", md3dDevice);
