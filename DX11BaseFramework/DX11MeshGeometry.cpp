...
DX11MeshGeometry::DX11MeshGeometry()
	: mVB(0), mIB(0), 
...
void DX11MeshGeometry::SetIndices(ID3D11Device* device, const USHORT* indices, UINT count)
{
...
void DX11MeshGeometry::SetSubsetTable(std::vector<Subset>& subsetTable)
{
	mSubsetTable = subsetTable;
}

void DX11MeshGeometry::Draw(ID3D11DeviceContext* dc, UINT subsetId)
{
    UINT offset = 0;
