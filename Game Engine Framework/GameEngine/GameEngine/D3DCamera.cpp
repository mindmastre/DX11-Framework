...
{
	SetLens(0.25f*PI, 1.0f, .10f, 10000.0f);
}
...
XMVECTOR D3DCamera::GetPositionXM()const
{
	return XMLoadFloat3(&mPosition);
}

XMFLOAT3 D3DCamera::GetPosition()const
{
	return mPosition;
}
...
void D3DCamera::SetPosition(const XMFLOAT3& v)
{
	mPosition = v;
}

XMVECTOR D3DCamera::GetRightXM()const
{
	return XMLoadFloat3(&mRight);
}

XMFLOAT3 D3DCamera::GetRight()const
{
	return mRight;
}

XMVECTOR D3DCamera::GetUpXM()const
{
...
XMVECTOR D3DCamera::GetLookXM()const
{
	return XMLoadFloat3(&mLook);
}

XMFLOAT3 D3DCamera::GetLook()const
{
	return mLook;
}
...
void D3DCamera::LookAt(const XMFLOAT3& pos, const XMFLOAT3& target, const XMFLOAT3& up)
{
...
XMMATRIX D3DCamera::View()const
{
	return XMLoadFloat4x4(&mView);
}

XMMATRIX D3DCamera::Proj()const
{
	return XMLoadFloat4x4(&mProj);
}

XMMATRIX D3DCamera::ViewProj()const
{
